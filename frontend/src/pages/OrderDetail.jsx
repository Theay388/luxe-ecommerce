  ...
  return (
    <main>
      <div className="container" style={{ padding: 'var(--space-10) var(--space-8)', maxWidth: '800px' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-serif)', marginTop: 'var(--space-4)', marginBottom: 'var(--space-8)' }}>
        ...
        <div style={{ background: 'var(--color-bg-low)', padding: 'var(--space-6)', marginBottom: 'var(--space-6)' }}>
          <p className="text-uppercase text-small text-muted" style={{ marginBottom: 'var(--space-4)' }}>
            Items
          </p>
          ...
          {(order.items || []).map((item, i) => (
            <div key={i} style={{
              ...
              borderBottom: '1px solid rgba(153,143,129,0.1)'
            }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-6)' }}>
          ...
          <div style={{ background: 'var(--color-bg-low)', padding: 'var(--space-6)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 'var(--space-3)', fontFamily: 'var(--font-serif)' }}>
              <span>Total</span>
              <span style={{ color: 'var(--color-gold-lt)' }}>{fmt(order.totalPrice)}</span>
            </div>
          </div>
        </div>
